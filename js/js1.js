	...
	//message_send
		(function(){
			var send=function(user,time,mes,s){			
				...
				var h_text="<div class="+clas+"><img src=imgs/"+user+".png class="+clas+"_face><div class='detail_message'><div><span class="+clas+"_name>"+date[user].name+"</span><span class='time_2'>"+time+"</span></div><p class=message_content><pre>"+mes+"</pre></p></div></div>";
